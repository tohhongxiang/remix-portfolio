...
export default function HeroSection() {
    ...
    return (
        ...
        >
            <div className="flex flex-grow flex-col items-center justify-center gap-4 md:flex-row">
                <LightDarkVariant
                    light={
                        <img
                            src="/images/hero.png"
                            alt=""
                            className="mx-auto h-auto w-full max-w-[300px] px-4"
                        />
                    }
                    dark={
                        <img
                ...
                <div className="flex flex-col gap-y-4 p-4">
                    ...
                    <p
                        className={cn(
                            "mb-4 text-center text-xl font-medium tracking-tight opacity-60 md:text-left"
                        )}
                    >
        ...
        <div className="flex flex-wrap items-center justify-center gap-8 md:justify-start">
            ...
            >
                <svg
                    ...
                    className="h-8 w-8 fill-foreground dark:fill-foreground sm:h-16 sm:w-16"
                >
                    <title>GitHub</title>
